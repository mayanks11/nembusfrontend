...
class NewCustomers extends Component {
  ...
  onDeleteCustomer(customer) {
    this.setState({ selectedDeletedCustomer: customer, dialog: true });
  }

  // delete customer
  deleteCustomer() {
    this.setState({ sectionReload: true, dialog: false });
  ...
  onSubmitAddNewCustomerForm() {
    ...
    if (
      addNewCustomerDetails.customer_name !== '' &&
      addNewCustomerDetails.customer_email !== ''
    ) {
    ...
    return (
      <Fragment>
        ...
        <DeleteConfirmationDialog
          ...
          deleteMessage='Are you sure want to delete this customer permanently'
          isDialogOpen={this.state.dialog}
          deleteHandler={this.deleteCustomer}
          cancelHandler={() => {
                ...
                <Form>
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        this.onChangeCustomerAddNewForm(
                          'customer_name',
                          e.target.value
                        )
                      }
